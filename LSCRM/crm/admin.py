...
class CustomerAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ['consult_courses',] #水平的
    # list_per_page = 2
    actions = ['change_status',]
    def change_status(self,request,querysets): #自定义函数,进行批量修改
        querysets.update(status=1)
class CourseReccrdAdmin(admin.ModelAdmin):
...
admin.site.register(models.CourseRecord,CourseReccrdAdmin)
